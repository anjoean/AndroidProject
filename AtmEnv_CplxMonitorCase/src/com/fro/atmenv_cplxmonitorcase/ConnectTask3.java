 ...
 */
public class ConnectTask3 extends AsyncTask<Void, Void, Void> {
	...
	public ConnectTask3(Context context, TextView tem_tv,TextView hum_tv,TextView sun_tv,TextView pm25_tv, TextView info_tv) {
